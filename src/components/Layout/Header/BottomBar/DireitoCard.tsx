    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
                <div className={`flex flex-col items-center justify-center gap-2 ${isOpen ? 'wrapper-opened md:-translate-y-6' : 'wrapper-closed -translate-y-0'} `}>
                ...
                {isOpen ? 
                    <Link href='#' className={`button-opened hidden md:flex bg-transparent text-white rounded-lg py-4 px-6 transition hover:bg-white hover:text-black duration-500 border-[1px] border-white`}>Saiba mais</Link>
                    :
                    <Link href='#' className={`button-closed hidden bg-transparent text-white rounded-lg py-4 px-6 transition hover:bg-white hover:text-black duration-500 border-[1px] border-white`}>Saiba mais</Link>
                }
            </div>
        </div>
    )
