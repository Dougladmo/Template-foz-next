    ...
    return (
        <div id='newsLetter' className='flex flex-col gap-3 md:max-w-[375px] lg:min-w-[250px]'>
            ...
            <form className='grid grid-cols-3 grid-rows-2 gap-2'>
                ...
                <input className="cursor-pointer col-span-1 bg-white text-blue-800 py-1 rounded-lg hover:text-white hover:bg-transparent border-2 border-white transition duration-500" type="submit" id='submit' name='submit' />
            </form>
        </div>
    )
}
